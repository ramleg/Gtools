(function() {
    ...
    var db = {
        ...
        loadData: function(filter) {
            return $.grep(this.positions, function(client) {
        ...
        insertItem: function(insertingClient) {
            this.positions.push(insertingClient);
        },

        updateItem: function(updatingClient) { },

        deleteItem: function(deletingClient) {
            var clientIndex = $.inArray(deletingClient, this.positions);
            this.positions.splice(clientIndex, 1);
        }
    ...
    db.ouorg = [
        ...
        { Name: "PM", Id: 2 },
        { Name: "Staffing", Id: 3 },
        { Name: "Recruiting", Id: 4 },
        { Name: "QC", Id: 5 },
        { Name: "Reception", Id: 6 },
        { Name: "Facilities", Id: 7 },
    ];
