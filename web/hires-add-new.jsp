                    ...
                    <form class="form-inline">
                        ...
                        <div class="row">
                            <div class="input-group col-sm-12 col-md-10">
                                ...
                                <select class="form-control" id="txt-domain">
                                    <option>GLOBANT DOMAIN</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-group col-sm-12 col-md-5">
                                <div class="input-group-addon">></div>
                                <input class="form-control text-lowercase" id="txt-user" placeholder="User">
                            </div>
                            <div class="input-group col-sm-12 col-md-5">
                                <div class="input-group-addon">@</div>
                                <select class="form-control" id="txt-domain">
                        ...
                        <div class="row">
                            <div class="input-group col-sm-12 col-md-5">
                                ...
                                <select class="form-control" id="dd-country"><option value=""> - - - - - - - - - - - - - - - - - - - - - - </option></select>
                            </div>
                            <div class="input-group col-sm-12 col-md-5">
                                <div class="input-group-addon">></div>
                        ...
                        <div class="row">
                            <div class="input-group col-sm-12 col-md-5">
                                ...
                                <select class="form-control" id="dd-position"><option value=""> - - - - - - - - - - - - - - - - - - - - - - </option></select>
                            </div>
                            <div class="input-group col-sm-12 col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group col-sm-12 col-md-2 col-md-offset-6 col-sm-offset-0">
                                <button type="button" class="btn btn-block btn-danger">Clear / Cancel</button>
                            </div>
                        </div>
                    </form>
                </div>
